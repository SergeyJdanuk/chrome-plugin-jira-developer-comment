...
gulp.task('clean', function() {
  return del(['dist/assets/css', 'dist/assets/js', 'dist/assets/images', 'dist/assets/fonts', 'dist/*.html', 'dist/**/*.json']);
});
...
gulp.task('default', ['clean', 'sprites', 'iconfont'], function() {
  gulp.start('css', 'js', 'images', 'templates', 'fonts', 'json');
});
...
gulp.task('watch', ['connect', 'serve'], function() {
  ...
  gulp.watch(['dist/assets/**', 'dist/*.html', 'dist/**/*.json']).on('change', function(file) {
